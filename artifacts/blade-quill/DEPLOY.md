...
| `ANTHROPIC_API_KEY`          | Vercel Dashboard            | Yes for AI SEO suggestions — Anthropic API key used by `api/seo-suggest.ts` (the CMS "SEO Assistant"). Without it the SEO fields still work; only the auto-suggestions are off                                                                                            |
| `SEO_SUGGEST_MODEL`          | Vercel Dashboard            | No — Claude model for SEO suggestions (defaults to `claude-haiku-4-5`)                                                                                                                                                                                                    |
