...
export const FALLBACK_TUTORIALS: Tutorial[] = [
  ...
  { id: 2, title: "Krita for Beginners — Complete Interface Walkthrough", youtubeId: "Ccqw9x4NPno", description: "A full tour of Krita's interface and workspace customization.", topic: "Learning Krita", featured: true, createdAt: ts },
  { id: 3, title: "Layers in Krita — Everything You Need to Know", youtubeId: "MS3vSR93ADU", description: "Master layers, groups, blending modes, and opacity.", topic: "Learning Krita", featured: false, createdAt: ts },
  { id: 4, title: "Krita Selection Tools — Complete Guide", youtubeId: "n9anWigHNDo", description: "A comprehensive walkthrough of all Krita selection tools.", topic: "Tools", featured: false, createdAt: ts },
  { id: 5, title: "Creating a Vector Image in Krita", youtubeId: "QNXg9H-ru8s", description: "Create crisp, scalable vector images using Krita's vector tools.", topic: "Tools", featured: false, createdAt: ts },
  { id: 6, title: "Transform Tool Deep Dive", youtubeId: "wlc4hQjOQKQ", description: "Scale, rotate, skew, and warp with precision.", topic: "Tools", featured: false, createdAt: ts },
  { id: 7, title: "How to Install and Manage Brushes in Krita", youtubeId: "Fxy8hJUKY10", description: "Download, install, organize, and create custom brush packs.", topic: "Brushes", featured: true, createdAt: ts },
  { id: 8, title: "Create Your Own Custom Brushes in Krita", youtubeId: "zkYan4OJwt8", description: "Step-by-step guide to building brushes from scratch.", topic: "Brushes", featured: false, createdAt: ts },
  ...
  { id: 10, title: "How to Add Highlights and Shadows Digitally", youtubeId: "3VixvkRggFs", description: "Proper light and shadow placement for depth and dimension.", topic: "Digital Painting", featured: false, createdAt: ts },
  { id: 11, title: "Digital Coloring Techniques for Beginners", youtubeId: "mpTVuC0ypa0", description: "From flat colors to blended shading in Krita.", topic: "Digital Painting", featured: false, createdAt: ts },
  { id: 12, title: "How to Draw a Chibi Character from Scratch", youtubeId: "PARrJS9Ekp4", description: "Design adorable chibi characters step by step.", topic: "Character Design", featured: true, createdAt: ts },
  { id: 13, title: "Designing Fantasy Characters — Armor and Costumes", youtubeId: "JPfFfnzdOoo", description: "Tips for designing memorable fantasy characters.", topic: "Character Design", featured: false, createdAt: ts },
  ...
  { id: 15, title: "Faster Krita: Fix These 8 Lag Issues Now", youtubeId: "VcouFDV5XYE", description: "Identify and fix the 8 most common causes of Krita lag.", topic: "Tips & Tricks", featured: false, createdAt: ts },
  { id: 16, title: "10 Krita Shortcuts Every Artist Should Know", youtubeId: "PzXEZ5QlW7U", description: "Essential keyboard shortcuts and hidden features.", topic: "Tips & Tricks", featured: false, createdAt: ts },
  { id: 17, title: "Getting Started with Animation in Krita", youtubeId: "K7e1JxEeXTY", description: "Create your first frame-by-frame animation in Krita.", topic: "Animation", featured: false, createdAt: ts },
  { id: 18, title: "Vector Drawing in Krita — Complete Guide", youtubeId: "yK-H40ELzhE", description: "Create scalable vector art using shape tools, paths, and vector layers.", topic: "Vectors", featured: false, createdAt: ts },
  { id: 19, title: "Creating Seamless Textures in Krita", youtubeId: "EUxEgh_BVxM", description: "Design tileable textures using Krita's wrap-around mode.", topic: "Textures & Designs", featured: false, createdAt: ts },
  { id: 20, title: "Pattern Design — From Sketch to Repeat", youtubeId: "Y3QZjqBQ5PY", description: "Turn a hand-drawn sketch into a professional repeating pattern.", topic: "Textures & Designs", featured: false, createdAt: ts },
];
